...
class MTAPI:
    ...
    def iOpen(self, symbol, period, shift):
        try:
            return float(self.MQL5("iopen," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(shift)))
        except:
            return None

    def iHigh(self, symbol, period, shift):
        try:
            return float(self.MQL5("ihigh," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(shift)))
        except:
            return None

    def iLow(self, symbol, period, shift):
        try:
            return float(self.MQL5("ilow," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(shift)))
        except:
            return None

    def iClose(self, symbol, period, shift):
        try:
            return float(self.MQL5("iclose," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(shift)))
        except:
            return None
    ...
    def iTime(self, symbol, period, shift):
        try:
            return datetime.strptime(
                self.MQL5("itime," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(shift)),
                "%Y.%m.%d %H:%M")
        except:
            return None
    ...
    def iVolume(self, symbol, period, shift):
        try:
            return int(self.MQL5("ivolume," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(shift)))
        except:
            return None
    ...
    def CopyRates(self, symbol, period, start_Pos, count):
        try:
            result = self.MQL5(
                "copyrates," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_Pos) + "," + str(count))
    ...
    def CopyRatesTC(self, symbol, period, start_time, count):
        try:
            result = self.MQL5(
                "copyratesTC," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    count))
            return [dictMQLRates(i) for i in result]
        except:
            return None
    ...
    def CopyRatesTT(self, symbol, period, start_time, stop_time):
        try:
            result = self.MQL5(
                "copyratesTT," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    stop_time))
            return [dictMQLRates(i) for i in result]
        except:
            return None
    ...
    def CopyOpen(self, symbol, period, start_pos, count):
        try:
            result = self.MQL5(
                "copyopen," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_pos) + "," + str(count))[
                0]
    ...
    def CopyOpenTC(self, symbol, period, start_time, count):
        try:
            result = self.MQL5(
                "copyopenTC," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    count))[0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyOpenTT(self, symbol, period, start_time, stop_time):
        try:
            result = self.MQL5(
                "copyopenTT," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    stop_time))[0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyHigh(self, symbol, period, start_pos, count):
        try:
            result = self.MQL5(
                "copyhigh," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_pos) + "," + str(count))[
                0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyHighTC(self, symbol, period, start_time, count):
        try:
            result = self.MQL5(
                "copyhighTC," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    count))[0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyHighTT(self, symbol, period, start_time, stop_time):
        try:
            result = self.MQL5(
                "copyhighTT," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    stop_time))[0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyLow(self, symbol, period, start_pos, count):
        try:
            result = self.MQL5(
                "copylow," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_pos) + "," + str(count))[
                0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyLowTC(self, symbol, period, start_time, count):
        try:
            result = self.MQL5(
                "copylowTC," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    count))[0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyLowTT(self, symbol, period, start_time, stop_time):
        try:
            result = self.MQL5(
                "copylowTT," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    stop_time))[0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyClose(self, symbol, period, start_pos, count):
        try:
            result = self.MQL5(
                "copyclose," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_pos) + "," + str(
                    count))[0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyCloseTC(self, symbol, period, start_time, count):
        try:
            result = self.MQL5(
                "copycloseTC," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    count))[0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyCloseTT(self, symbol, period, start_time, stop_time):
        try:
            result = self.MQL5(
                "copycloseTT," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    stop_time))[0]
            return [float(i) for i in result]
        except:
            return None
    ...
    def CopyVolume(self, symbol, period, start_pos, count):
        try:
            result = self.MQL5(
                "copyvolume," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_pos) + "," + str(
                    count))[0]
    ...
    def CopyVolumeTC(self, symbol, period, start_time, count):
        try:
            result = self.MQL5(
                "copyvolumeTC," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    count))[0]
            return [int(i) for i in result]
        except:
            return None
    ...
    def CopyVolumeTT(self, symbol, period, start_time, stop_time):
        try:
            result = self.MQL5(
                "copyvolumeTT," + str(symbol).upper() + "," + MQL5Period(period) + "," + str(start_time) + "," + str(
                    stop_time))[0]
            return [int(i) for i in result]
        except:
            return None
    ...
    def CopyTicksRange(self, symbol, Start_Time_MSC, Stop_Time_MSC):
        try:
            result = self.MQL5(
                "copyticksrange," + str(symbol).upper() + "," + str(Start_Time_MSC) + "," + str(Stop_Time_MSC))
            return [dictMQLTick(i) for i in result]
        except:
            return None
    ...
    def Buy(self, symbol, volume, price, sl, tp, comment):
        try:
            return int(self.MQL5(
                "buy," + str(symbol).upper() + "," + str(volume) + "," + str(price) + "," + str(sl) + "," + str(
                    tp) + "," + str(comment)))
        except:
            return None
    ...
    def Sell(self, symbol, volume, price, sl, tp, comment):
        try:
            return int(self.MQL5(
                "sell," + str(symbol).upper() + "," + str(volume) + "," + str(price) + "," + str(sl) + "," + str(
                    tp) + "," + str(comment)))
        except:
            return None
    ...
    def BuyLimit(self, symbol, volume, price, sl, tp, comment):
        try:
            return int(self.MQL5(
                "buylimit," + str(symbol).upper() + "," + str(volume) + "," + str(price) + "," + str(sl) + "," + str(
                    tp) + "," + str(comment)))
        except:
            return None
    ...
    def SellLimit(self, symbol, volume, price, sl, tp, comment):
        try:
            return int(self.MQL5(
                "selllimit," + str(symbol).upper() + "," + str(volume) + "," + str(price) + "," + str(sl) + "," + str(
                    tp) + "," + str(comment)))
        except:
            return None
    ...
    def BuyStop(self, symbol, volume, price, sl, tp, comment):
        try:
            return int(self.MQL5(
                "buystop," + str(symbol).upper() + "," + str(volume) + "," + str(price) + "," + str(sl) + "," + str(
                    tp) + "," + str(comment)))
        except:
            return None
    ...
    def SellStop(self, symbol, volume, price, sl, tp, comment):
        try:
            return int(self.MQL5(
                "sellstop," + str(symbol).upper() + "," + str(volume) + "," + str(price) + "," + str(sl) + "," + str(
                    tp) + "," + str(comment)))
        except:
            return None
